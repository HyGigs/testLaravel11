        ...
        <ul class="space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <x-dashboard-sidelink href="/dashboard-students" :active="request()->is('dashboard-student')">Student</x-dashboard-sidelink>
              </li>
              <li>
                <x-dashboard-sidelink href="/dashboard-grades" :active="request()->is('dashboard-grade')">Grade</x-dashboard-sidelink>
              </li>
              <li>
                <x-dashboard-sidelink href="/dashboard-departments" :active="request()->is('dashboard-department')">Department</x-dashboard-sidelink>
              </li>
            </ul>
          </li>
          <li>
